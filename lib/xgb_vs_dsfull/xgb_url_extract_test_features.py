"""
xgb_url_extract_test_features.py
================================
Module trích xuất 100% đặc trưng từ chuỗi URL thô (Pure URL Features) cho XGBoost.
Không thực hiện bất kỳ truy vấn mạng hoặc DNS/WHOIS nào để đảm bảo:
  - Tốc độ dự đoán cực nhanh (mili-giây).
...
COMMON_TLDS = {
    ...
    'co', 'io', 'me', 'info', 'biz', 'name', 'mobi', 'pro',
    'aero', 'asia', 'cat', 'coop', 'jobs', 'museum', 'tel', 'travel',
    'uk', 'us', 'ca', 'de', 'fr', 'jp', 'cn', 'ru', 'br', 'au',
    'in', 'it', 'nl', 'se', 'no', 'es', 'pl', 'ch', 'at', 'be',
    'dk', 'fi', 'ie', 'pt', 'cz', 'hu', 'ro', 'bg', 'hr', 'sk',
    'si', 'lt', 'lv', 'ee', 'mt', 'cy', 'lu', 'is', 'li', 'mc',
    'vn', 'th', 'ph', 'my', 'sg', 'id', 'kr', 'tw', 'hk',
    'za', 'ng', 'ke', 'eg', 'gh', 'tz', 'ma', 'dz', 'tn',
    'ar', 'cl', 'co', 'mx', 'pe', 've', 'ec', 'uy', 'py',
    'nz', 'pk', 'bd', 'lk', 'np', 'mm', 'kh', 'la',
    'xyz', 'top', 'wang', 'club', 'vip', 'shop', 'site', 'online',
    'store', 'tech', 'space', 'fun', 'website', 'press', 'host',
    'buzz', 'blog', 'art', 'dev', 'app', 'page', 'cloud',
}
...
URL_SHORTENERS = {
    ...
    'su.pr', 'rebrand.ly', 'cutt.ly', 'short.io', 'rb.gy',
    'tiny.cc', 'shorturl.at', 'v.gd', 'clck.ru', 'qr.ae',
}
...
def _extract_special_chars(text):
    if text is None:
        return {
            'dot': -1, 'hyphen': -1, 'underline': -1, 'slash': -1,
            'questionmark': -1, 'equal': -1, 'at': -1, 'and': -1,
            'exclamation': -1, 'space': -1, 'tilde': -1, 'comma': -1,
            'plus': -1, 'asterisk': -1, 'hashtag': -1, 'dollar': -1,
            'percent': -1,
        }
